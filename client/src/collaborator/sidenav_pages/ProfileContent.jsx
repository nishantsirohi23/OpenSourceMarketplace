    ...
    <div>
      ...
      <Box bg={'white'}  w={['100%', '100%', '75%']} height="auto" position={"absolute"}  borderRadius="xl" marginTop={'25vh'} justifyContent={"space-between"}>
        <VStack  align={"flex-start"} padding={5} spacing={7}>
          ...
          >
            <Box  w={['90%', '70%', '100%']}>
              <VStack align={'flex-start'} w={'100%'}>
                <Text fontWeight={'medium'} color={'black'} fontSize={'xl'}>SkillSet</Text>
                <Text fontWeight={'medium'} color={'gray.700'} fontSize={'md'}>Expertise</Text>
            ...
            <Box  w={['90%', '70%', '100%']}>
              <VStack align={'flex-start'}>
                ...
                <IconButton
                  ...
                  variant="ghost" // You can choose the button variant that suits your design
                /> 
                </Link>
                </HStack>
                <Text
          ...
          <Box>
          <VStack align={"flex-start"}>
          <Text fontWeight={'medium'} color={'black'} fontSize={'xl'}>Tasks</Text>
              ...
              user.creatorProjects.map((project, index) => (
                <Grid item key={index} >
                  <ProjectCard
                    ...
                    avatarImages={project.contributorsData.map(contributor => contributor.profilePicture)}
